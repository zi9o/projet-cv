                                    ...
                                    <div class="col-lg-12">
                                        <form class="form-horizontal form-bordered">
                                            <div class="form-body">
                                                <div class="form-group">
                                                    <div class="col-lg-12">
                                                        <textarea name="content" ng-model="loisir.description" data-provide="markdown" rows="10"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-actions">
                                                <button type="submit" class="btn btn-primary btn-lg" ng-click="updateLangue(loisir)" >Sauvegarder   <i ng-show="loadingLoisir" class="fa fa-spinner fa-spin"></i></button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
